...
private ?int $nbrparticipants;
    ...
    #[ORM\OneToMany(mappedBy: 'EventId', targetEntity: TaskEvent::class, cascade: ["persist"])]
    ...
    public function removeTaskEvent(TaskEvent $taskEvent): static
    {
        if ($this->taskEvents->removeElement($taskEvent)) {
            // set the owning side to null (unless already changed)
            if ($taskEvent->getEventId() === $this) {
                $taskEvent->setEventId(null);
            }
        }
