...
->add('description', TextType::class, [
    'mapped' => false, // Not mapped to the Event entity
    'required' => false,
    'constraints' => [
        new NotBlank(['message' => 'Tu dois fournir une description.']),
    ],
])
// Add the state (Etat) field
->add('etat', ChoiceType::class, [
    'mapped' => false, // Not mapped to the Event entity
    'required' => false,
    'constraints' => [
        new NotBlank(['message' => 'Tu dois sélectionner un état.']),
    ],
    'choices' => [
        'Pending' => 'Pending',
