...
{
    #[Route('/stadium', name: 'app_stadium_index', methods: ['GET'])]
    ...
    public function book(string $stadiumId): Response
    {
        return $this->render('reservation/add_reservation.html.twig', ['stadiumId' => $stadiumId,
        ]);
    }


    #[Route('/stadium/{id}/stadiums', name: 'app_club_stadiums', methods: ['GET'])]
...
#[Route('/stadium/new/{clubId}', name: 'app_stadium_new', methods: ['GET', 'POST'])]
public function new(Request $request, EntityManagerInterface $entityManager, ClubRepository $clubRepository, $clubId): Response
{
    ...
    #[Route('/stadium/{reference}', name: 'app_stadium_show', methods: ['GET'])]
    ...
    #[Route('/stadium/{reference}/edit', name: 'app_stadium_edit', methods: ['GET', 'POST'])]
public function edit(Request $request, Stadium $stadium, EntityManagerInterface $entityManager): Response
{
    ...
    #[Route('/stadium/{reference}', name: 'app_stadium_delete', methods: ['POST'])]
