...
class CartController extends AbstractController
{
     ...
     */
    public function updateQuantity(Request $request, Cart $cart): Response
    {
        ...
        // Recalculate total price (assuming $cart->getProduct()->getPrice() retrieves the product price)
        $cart->setPriceTotal($newQuantity * $cart->getidProduct()->getPrice());

        // Save changes
        $entityManager = $this->getDoctrine()->getManager();
        $entityManager->flush();

        // Redirect back to cart index or do whatever you need
